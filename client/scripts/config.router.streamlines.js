      ...
      function ( $stateProvider,   $urlRouterProvider,  MODULE_CONFIG, BASE_URL ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.course_streamlines', {
              url: '?streamlineId',
              templateUrl: BASE_URL + '/views/pages/course_streamlines.html',
              data : { title: 'Course streamlines' },
              controller: 'CourseStreamlinesCtrl',
              resolve: load([BASE_URL + '/scripts/controllers/course/streamlines.js',
                             BASE_URL + '/scripts/controllers/streamline/modal/create_edit.js', 'textAngular', 'videosharing-embed'])
            })
            .state('404', {
              url: '/404',
