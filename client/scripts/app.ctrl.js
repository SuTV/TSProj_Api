 ...
 */
angular.module('app')  
  .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', '$document', '$location', '$rootScope', '$timeout', '$mdSidenav', '$mdColorPalette', '$anchorScroll', '$uibModal', '$mdToast', '$mdDialog', '$state', '$stateParams', '$q', 'LoopBackAuth', 'Category', 'Course', 'Reaction', 'User', 'API_DOMAIN', 'BASE_URL', 'USER_NO_AVATAR_IMG', 'NO_IMGAGE_IMG', 'NO_IMGAGE_IMG_RECTANGLE', 'EMBEDDING_PROVIDERS',
    function (             $scope,   $translate,   $localStorage,   $window,   $document,   $location,   $rootScope,   $timeout,   $mdSidenav,   $mdColorPalette,   $anchorScroll,   $uibModal ,  $mdToast,   $mdDialog,   $state,   $stateParams,   $q,   LoopBackAuth,   Category,   Course,   Reaction,   User,   API_DOMAIN, BASE_URL,   USER_NO_AVATAR_IMG,   NO_IMGAGE_IMG,   NO_IMGAGE_IMG_RECTANGLE,   EMBEDDING_PROVIDERS) {
      ...
      $scope.doSearch = function () {
        ...
        window.location.href = $rootScope.baseUrl + '/search/#/?q=' + $scope.app.search.content;
      }
      ...
      $rootScope.getUploadUrl = function(url) {
        return API_DOMAIN + '/api/containers/' + url + '/upload?access_token=' + LoopBackAuth.accessTokenId;
      };

      $scope.showUserNav = false;
      $rootScope.isAuthenticated = false;
      $rootScope.apiDomain = API_DOMAIN;
      $rootScope.currentUserAvatar =  $rootScope.userNoAvatarImg = BASE_URL + '/' + USER_NO_AVATAR_IMG;
      $rootScope.noImageImg = BASE_URL + '/' + NO_IMGAGE_IMG;
      $rootScope.noImageImgRectangle = BASE_URL + '/' + NO_IMGAGE_IMG_RECTANGLE;
