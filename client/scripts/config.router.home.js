      ...
      function ( $stateProvider,   $urlRouterProvider,  MODULE_CONFIG, BASE_URL ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.home', {
              url: '',
              templateUrl: BASE_URL + '/views/pages/home.html',
              data : { title: 'Home' },
              controller: 'HomeCtrl',
              resolve: load([BASE_URL + '/scripts/controllers/home.js',
                              BASE_URL + '/scripts/controllers/course/modal/create_edit.js', 
                              'ckeditor', 'ng.ckeditor', 'ui.select2', 'ngImageDimensions', 'angularFileUpload'])
            })
            .state('404', {
              url: '/404',
