      ...
      function ( $stateProvider,   $urlRouterProvider,  MODULE_CONFIG, BASE_URL ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.exam', {
              url: '',
              templateUrl: BASE_URL + '/views/pages/exam_details.html',
              data : { title: 'Exam details' },
              controller: 'ExamDetailsCtrl',
              resolve: load([BASE_URL + '/scripts/controllers/exam/details.js',
                             BASE_URL + '/scripts/controllers/exam/modal/create_edit.js',
                             BASE_URL + '/scripts/controllers/question/modal/create_edit.js',
                             BASE_URL + '/scripts/controllers/answer/modal/create_edit.js',
                             'textAngular', 'countdownTimer'])
            })
            .state('404', {
              url: '/404',
