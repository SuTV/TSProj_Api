      ...
      function ( $stateProvider,   $urlRouterProvider,  MODULE_CONFIG, BASE_URL ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.lecture', {
              url: '',
              templateUrl: BASE_URL + '/views/pages/lecture_details.html',
              data : { title: 'Lecture details' },
              controller: 'LectureDetailsCtrl',
              resolve: load([BASE_URL + '/scripts/controllers/lecture/details.js',
                             ...
                             BASE_URL + '/scripts/controllers/embedding/modal/create_edit.js',
