app.controller('CourseDetailsCtrl', ['$scope', '$rootScope', '$q', '$uibModal', '$state', '$mdToast', '$translate', '$mdDialog', 'Course', 'Container', 'Attachment', 'API_DOMAIN',  
                             function($scope, $rootScope, $q, $uibModal, $state, $mdToast, $translate, $mdDialog, Course, Container, Attachment, API_DOMAIN) {
  $scope.course = {};
  $scope.exams = [];
  $scope.plans = [];
  $scope.attachments = [];
