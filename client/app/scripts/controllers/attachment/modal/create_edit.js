app.controller('CreateEditAttachmentModalCtrl', ['$scope', '$rootScope', '$uibModalInstance', '$mdToast', '$translate', 'FileUploader', 'LoopBackAuth', 'ATTACHMENT_PREFIX_COURSE', 'ATTACHMENT_PREFIX_LECTURE', 'Container', 'Attachment', 'Course', 'Lecture', 'attachmentData', 'courseId', 'lectureId', 
								 function($scope, $rootScope, $uibModalInstance, $mdToast, $translate, FileUploader, LoopBackAuth, ATTACHMENT_PREFIX_COURSE, ATTACHMENT_PREFIX_LECTURE, Container, Attachment, Course, Lecture, attachmentData, courseId, lectureId) {
  $scope.attachment = {
  ...
  var uploader = $scope.uploader = new FileUploader({
    ...
    queueLimit: 1,
    url: '../api/containers/' + $scope.attachment.containerName + '/upload?access_token=' + LoopBackAuth.accessTokenId
  });
